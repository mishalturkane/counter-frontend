...
export type DecrementInput<TAccountCcfullstack extends string = string> = {
...
>(
  input: DecrementInput<TAccountCcfullstack>,
  config?: { programAddress?: TProgramAddress },
): DecrementInstruction<TProgramAddress, TAccountCcfullstack> {
  // Program address.
  ...
  return Object.freeze({
    ...
    programAddress,
  } as DecrementInstruction<TProgramAddress, TAccountCcfullstack>);
}
