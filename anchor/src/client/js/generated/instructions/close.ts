...
export type CloseInput<
  ...
  TAccountCcfullstack extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountCcfullstack>,
  config?: { programAddress?: TProgramAddress },
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountCcfullstack> {
  // Program address.
  ...
  return Object.freeze({
    accounts: [
      ...
      getAccountMeta(accounts.ccfullstack),
    ],
    data: getCloseInstructionDataEncoder().encode({}),
    programAddress,
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountCcfullstack>);
}
...
>(
  ...
  return {
    ...
    accounts: { payer: getNextAccount(), ccfullstack: getNextAccount() },
